...
- The plugin looks for KOReader's bundled `curl` first, then Android/Linux system paths. If no `curl` binary exists, it falls back to KOReader's Lua HTTP stack.
