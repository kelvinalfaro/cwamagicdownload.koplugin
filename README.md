...
- When author subfolders are enabled, existing books in the shelf folder are moved into the matching author folder during sync when possible.
...
- A rate-limited progress dialog is shown during shelf sync so long downloads no longer look frozen without constantly redrawing the full screen.
